/* github.com/igorescobar/jQuery-Mask-Plugin v1.14.16 */
...
/* Swiper 6.3.5 https://swiperjs.com Copyright 2014-2020 Vladimir Kharlampidi */
...
/* ramen-js */
jQuery(document).ready(function(a){var d=function(c){return 11===c.replace(/\D/g,"").length?"(00) 00000-0000":"(00) 0000-00009"};a("input[type=tel]").mask(d,{onKeyPress:function(c,e,b,f){b.mask(d.apply({},arguments),f)}});a(function(){a("#call-me-form").on("submit",function(c){c.preventDefault();a(".form-result-alert",this).hide();c=a(this);var e=c.attr("action");a.ajax({url:e,method:"POST",dataType:"json",data:c.serialize()}).success(function(b){console.log(b);console.log(typeof b);"calling"==b.type?
a("#success-modal").css("display","block"):(a(".form-result-alert").html(b.message),a(".form-result-alert").show())}).error(function(b){a(".form-result-alert").html(b.msgDeErro);a(".form-result-alert").show()})})})});
/* landing-js */
var swiperCases = new Swiper('#cases-container', { autoHeight: true, pagination: { el: '.swiper-pagination', clickable: true }, navigation: { nextEl: '.swiper-button-next', prevEl: '.swiper-button-prev' }}); var swiperBrands = new Swiper('#brands-container', { autoHeight: true, slidesPerView: 1, spaceBetween: 30, breakpoints: { 360 : { slidesPerView: 2, spaceBetween: 10 }, 768 : {slidesPerView: 4, spaceBetween: 20 }}, loop: true, autoplay: {delay: 3000, disableOnInteraction: false }}); var successModal = document.getElementById("success-modal"); var successClose = document.getElementById("close-success"); var okBtn = document.getElementById("close-success-btn"); okBtn.onclick = function() {successModal.style.display = "none";}; successClose.onclick = function() {successModal.style.display = "none";}; window.onclick = function(event) {if (event.target == successModal ) {successModal.style.display = "none"; }}; jQuery(document).ready(function ($) { $( ".open-call-me" ).click(function() { $( "#call-me" ).toggle( "slow" ); }); $( "#scroll-down" ).click(function() { $('html, body').animate({ scrollTop: $(".form-section").offset().top }, 450); }); });
var circleP = document.getElementById('circle-p').offsetHeight; document.getElementById('circle-p2').style.top = circleP + 'px'; document.getElementById('circle-p3').style.top = (circleP * 2) + 'px'; document.getElementById('circle-p4').style.top = (circleP * 3) + 'px'; window.addEventListener('scroll', () => { var scrollCalc = (window.pageYOffset / (500 - 200) * 100).toFixed(); var scrollDeg = scrollCalc + 'deg'; document.body.style.setProperty('--scrollDeg',scrollDeg); var scrollPCalc = (window.pageYOffset * -.2).toFixed(); var scrollPerc = scrollPCalc + 'px'; document.body.style.setProperty('--scrollPerc',scrollPerc); }, false);